...
import {
	allCardsElement,
	arrowElement,
	generationNameElement,
	infoContainerElement,
	miniPkbllElement,
	pokeGridElement,
	pokeImageLoaderElement,
	pokeViewElement,
	pokeViewHeaderElement,
	pokeballBgElement,
	selectGenElement
} from './dom';
...
export const changePokeNumber = pokeNumber => {
	if (pokeNumber < 10) {
...
export const chargePkmn = async URL => {
...
export const toggleShiny = pokeData => {
...
export const openPokemon = async event => {
...
export const busqueda = async palabraBuqueda => {
